...
export default async function LoginPage({ searchParams }: { searchParams: Promise<{ next?: string }> }) {
  ...
  return <main className="auth-shell">
    ...
    <section className="auth-card">
      <div className="auth-copy"><span className="section-kicker">SECURE STUDENT ACCESS</span><h1>One profile. One workspace. A clearer scholarship plan.</h1><p>Sign in to store documents, build an evidence-led profile, review your Top Five options and track consultant next steps.</p><ul><li>Private document storage</li><li>Secure passwordless email access</li><li>Official sources retained with every match</li></ul></div>
      <div className="auth-form"><span className="eyebrow">WELCOME TO YOUR WORKSPACE</span><h2>Sign in or create your student account</h2><p>No password to remember. We will send a secure sign-in link to your email.</p><AuthClient config={config} next={next} /></div>
    </section>
